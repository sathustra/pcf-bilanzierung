"""Seed helpers – run via FastAPI lifespan or directly as a script."""
import time
...
def run_seed(engine, SessionLocal, models):
    if not wait_for_db(engine):
        print("WARNING: Could not connect to DB – seed skipped.")
        return
    ...
    if db.query(models.Product).count() == 0:
        ...
        db.add(models.EnergyEntry(
            ...
            process_step="Druckmaschinen & Weiterverarbeitung", batch_amount=320_000,
        ...
        db.add(models.EnergyEntry(
            ...
            process_step="Beleuchtung & Lager", batch_amount=45_000,
        ...
        db.add(models.EnergyEntry(
            ...
            process_step="Trocknung & Heizung", batch_amount=180_000,
        ...
        db.add(models.TransportEntry(
            ...
            distance_km=850, transport_mode="LKW 25t", batch_weight_kg=480_000,
        ...
        db.add(models.TransportEntry(
            ...
            distance_km=220, transport_mode="LKW 25t", batch_weight_kg=8_500,
            ef_id=ef_ids["LKW Transport (25t, EURO VI)"],
            life_cycle_stage=models.LifeCycleStage.transport_storage,
            sub_category=models.SubCategory.inbound_transport,
        ))
